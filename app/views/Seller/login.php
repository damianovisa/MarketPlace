...
<!-- <form class="row g-3 needs-validation" action="" method="post" novalidate>
    ...
    <div class="col-12">
        <input class="btn btn-primary" name="action" type="submit" href="/Seller/Register" value="Login">
        <a class="btn btn-primary" name="action" type="submit" href="/User/login" ><?=("User Login")?></a>
    </div>
</form> -->
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="/User/login" class="text-body">Sign in as a User</a>
                </div>

                <div class="text-center text-lg-start mt-4 pt-2">
                <input class="btn btn-primary btn-lg" name="action" type="submit" href="/User/login" value="Login">
                    <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="/Seller/register"
